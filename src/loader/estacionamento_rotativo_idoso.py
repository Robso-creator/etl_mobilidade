...
from src.database.models import EstacionamentoRotativoIdoso
...
_log = SetupLogger('src.loader.estacionamento_rotativo_idoso')
...
def main():
    ...
    send_to_db(df_final, EstacionamentoRotativoIdoso)
