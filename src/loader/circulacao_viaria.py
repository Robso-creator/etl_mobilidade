...
from src.database.models import CirculacaoViaria
...
_log = SetupLogger('src.loader.circulacao_viaria')
...
def main():
    ...
    send_to_db(df_final, CirculacaoViaria)


if __name__ == '__main__':
    main()

# python -m src.loader.circulacao_viaria
