...
from src.database.models import RedutorVelocidade
...
_log = SetupLogger('src.loader.redutor_velocidade')
...
def main():
    ...
    send_to_db(df_final, RedutorVelocidade)


if __name__ == '__main__':
    main()

# python -m src.loader.redutor_velocidade
