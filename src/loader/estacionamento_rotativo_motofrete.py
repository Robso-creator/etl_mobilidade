...
from src.database.models import EstacionamentoRotativoMotofrete
...
_log = SetupLogger('src.loader.estacionamento_rotativo_motofrete')


def main():
    s3_client = S3()
    folder = 'estacionamento-rotativo-para-motofrete'
    ...
    send_to_db(df_final, EstacionamentoRotativoMotofrete)


if __name__ == '__main__':
    main()

# python -m src.loader.estacionamento_rotativo_idoso
