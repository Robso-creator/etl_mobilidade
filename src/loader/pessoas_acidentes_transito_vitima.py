...
from src.database.models import PessoasAcidentesTransitoVitima
...
_log = SetupLogger('src.loader.pessoas_acidentes_transito_vitima')
...
def main():
    ...
    send_to_db(df_final, PessoasAcidentesTransitoVitima)


if __name__ == '__main__':
    main()

# python -m src.loader.pessoas_acidentes_transito_vitima
