...
from src.database.models import PostoVendaRotativo
...
_log = SetupLogger('src.loader.posto_de_venda_rotativo')
...
def main():
    ...
    send_to_db(df_final, PostoVendaRotativo)


if __name__ == '__main__':
    main()

# python -m src.loader.posto_venda_rotativo
