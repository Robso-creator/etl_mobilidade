...
from src.database.models import OcorrenciasAcidentesTransitoVitima
...
_log = SetupLogger('src.loader.ocorrencias_acidentes_transito_vitima')
...
def main():
    ...
    send_to_db(df_final, OcorrenciasAcidentesTransitoVitima)


if __name__ == '__main__':
    main()

# python -m src.loader.ocorrencias_acidentes_transito_vitima
