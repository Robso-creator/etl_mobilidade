...
class EstacionamentoRotativoMotofrete(Base):
    __tablename__ = 'estacionamento_rotativo_motofrete'

    dict_substitute = {
        'each_line_represents': 'um estacionamento rotativo para motofrete',
        'freshness': 'Indeterminada',
        'data_source': 'Localização das Vagas de Estacionamento para Motofrete',
        'product': 'Mobilidade',
    }
    __table_args__ = {
